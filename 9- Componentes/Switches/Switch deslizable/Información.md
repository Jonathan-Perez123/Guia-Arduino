...
Un switch deslizable es un tipo de switch que a diferencia de un botón este, al deslizarlo, manterndrá su valor, es decir, está deslizado o no deslizado por lo que no se podrán hacer ciertas tareas que si se pueden realizar en un botón como realizar una acción mientras este es presionado ya que solo tiene el valor de deslizado o no deslizado.
